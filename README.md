...
╭ Dni If u are prosshipper, darkshipper or etc,makes jokes about alcohol(I have very deep traumas, events that I've tried to heal from, but I'm still heavily affected and can't recover) or try to make me go on fight and ıf u are one of the boundary breakers(example; wemfrags, etc.) pls dni!! ;(
